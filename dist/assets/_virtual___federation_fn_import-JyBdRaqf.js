...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-z-BZoSEI.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-KmrQF9Fk.js', import.meta.url).href),import:true,requiredVersion:'^18.0.0'},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-DhnZ9-H4.js', import.meta.url).href),import:true,requiredVersion:'^6.0.0'},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-CrrUewJ5.js', import.meta.url).href),import:true,requiredVersion:'^5.0.0'}};
