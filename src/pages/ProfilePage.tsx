...
export default function ProfilePage() {
  ...
  const handleSubmitProfile = async (e: React.FormEvent) => {
    ...
    setSaving(true)
    try {
      await updateProfile({ firstName: firstName || undefined, lastName: lastName || undefined, phone: phone || undefined, avatar: avatar || undefined })
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground">
              Não foi possível carregar seu perfil. Verifique se você está logado e tente novamente.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-6 p-6">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Para ver custos e cobrança do seu tenant, acesse Administração → Tenants → Costs.
              </p>
              <Button variant="outline" size="sm" asChild>
                <a href="/admin/tenants/costs">Ver custos</a>
              </Button>
            </CardContent>
          </Card>
        </div>
